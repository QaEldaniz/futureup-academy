  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0b0f1a] via-[#111827] to-[#0b0f1a] relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        {/* Login Card */}
        <div className="bg-white dark:bg-[#141927]/80 backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-gray-800/50 shadow-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 rounded-xl bg-gray-900/50 border border-gray-200 dark:border-gray-700/50 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500/50 transition-all"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-12 py-3 rounded-xl bg-gray-900/50 border border-gray-200 dark:border-gray-700/50 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500/50 transition-all"
                />
                <button
                  type="button"
            ...
            <button
              ...
              disabled={isLoading}
              className={cn(
                'w-full py-3 rounded-xl font-semibold text-gray-900 dark:text-white transition-all duration-200',
