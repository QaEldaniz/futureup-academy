...
function StatusBadge({ status, isOverdue }: { status: string; isOverdue?: boolean }) {
  ...
  const config: Record<string, { label: string; color: string }> = {
    NOT_SUBMITTED: { label: 'Pending', color: 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">All assignments across your courses</p>
      </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1.5 text-xs text-primary-600 dark:text-primary-400 mb-2">
                    ...
                    {a.course.titleEn || a.course.titleAz}
                  </div>
                  <div className="flex flex-wrap gap-3 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <span className="flex items-center gap-1"><Award className="w-3 h-3" /> {a.maxScore} pts</span>
