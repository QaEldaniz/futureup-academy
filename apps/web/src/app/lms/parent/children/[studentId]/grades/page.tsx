...
export default function ParentChildGradesPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{childName || t('child')}{t('childGrades')}</h1>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-gray-500 dark:text-gray-400">{t('averageScore')}</p>
