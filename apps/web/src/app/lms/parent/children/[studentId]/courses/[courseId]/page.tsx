...
export default function ParentChildCourseDetail() {
  ...
  if (!data) return <div className="text-center py-20"><p className="text-gray-500">Course not found</p></div>;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6">
        <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{data.titleEn}</h1>
      ...
      {/* Lessons */}
      <div>
        <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Lesson Progress</h2>
          ...
          {data.lessons?.map((l: any, i: number) => {
            ...
            return (
              <div key={l.id} className="flex items-center gap-3 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4">
                ...
                <span className="text-sm font-medium text-gray-900 dark:text-white flex-1 truncate">{i + 1}. {l.titleEn}</span>
