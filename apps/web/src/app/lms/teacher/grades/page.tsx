  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <div>
          <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1">Type Filter</label>
          <select
            value={filterType}
            ...
            return (
              <div key={s.student.id} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-4 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-900 dark:text-white truncate">{s.student.name}</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">{count} grades</p>
                </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  ...
                  <th className="text-right px-4 py-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Date</th>
                </tr>
              </thead>
              <tbody>
                {grades.map((g) => (
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => setShowModal(false)}>
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 w-full max-w-md space-y-4" onClick={(e) => e.stopPropagation()}>
            ...
            <div>
              <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1">Student</label>
              <select
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1">Max Score</label>
                <input
                  type="number" min="1"
