      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {courses.map((tc: any) => (
            ...
            >
              {tc.course.image && <img src={tc.course.image} alt="" className="w-20 h-20 object-cover rounded-xl flex-shrink-0 hidden sm:block" />}
              <div className="flex-1">
                <h3 className="font-bold text-gray-900 dark:text-white">{tc.course.titleEn}</h3>
